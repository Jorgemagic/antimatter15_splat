...
async function main() {
    ...
    //const url = new URL("train.splat", "https://huggingface.co/cakewalk/splat-data/resolve/main/");
    const url = new URL("test.splat", "https://huggingface.co/Jorgemagic/splat-data/resolve/main/");
